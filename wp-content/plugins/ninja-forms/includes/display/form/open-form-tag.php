...
function ninja_forms_display_open_form_tag( $form_id ) {
	...
	?>
	<form role="form" id="ninja_forms_form_<?php echo $form_id;?>" enctype="multipart/form-data" method="post" name="" action="<?php echo $url;?>" class="ninja-forms-form<?php echo $form_class;?><?php echo $hide_class;?>">
